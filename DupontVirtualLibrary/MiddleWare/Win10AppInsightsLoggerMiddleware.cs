...
namespace BasicBot.Middleware
{
    ...
    /// </summary>
    public class Win10AppInsightsLoggerMiddleware : IMiddleware
    {
        /// <summary>
        /// The name of the App Insights Middleware in the Context TurnState collection.
        /// </summary>
        public static readonly string AppInsightsServiceKey = $"{nameof(Win10AppInsightsLoggerMiddleware)}.AppInsightsContext";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Win10AppInsightsLoggerMiddleware"/> class.
        /// </summary>
        ...
        public Win10AppInsightsLoggerMiddleware(string instrumentationKey, bool logUserName = false, bool logOriginalMessage = false, TelemetryConfiguration config = null)
        {
        ...
        public async Task OnTurnAsync(ITurnContext context, NextDelegate nextTurn, CancellationToken cancellationToken)
        {
            ...
            context.TurnState.Add(Win10AppInsightsLoggerMiddleware.AppInsightsServiceKey, _telemetryClient);
